...
def main(arguments=None):
    ...
    try:
        ...
        if options.merge:
            utils.header("Total Report", did.base.Config().separator_width, did.base.Config().separator_char)
        ...
        for user in users:
            if options.merge:
                ...
                utils.header(user, did.base.Config().separator_width, did.base.Config().separator_char)
